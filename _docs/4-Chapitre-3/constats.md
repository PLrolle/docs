...
order: 2
---
(sous titre 2) 1.1- Le contexte institutionnel
...
(sous titre 2) 1.2- Les opportunités européennes 
...
(note dans la marge) *D'après le baromètre territorial publié par le LabTerritorial, près de 700 millions d'euros de fonds européens n'ont pas été mobilisés par la France dans le cadre de la politique de cohésion entre 2007 et 2013. 

(note dans la marge) * _Source : Étude Capgemini-Caisse des Dépôts et Consignation et contribution de CAPP Europe._


```
(Encadré projet) L'exemple des Hauts-de-France
...
En chiffres :
Au 1er avril 2018 : 11 020 000 € de FEDER ont été accordés (17 projets) pour un coût total de plus de 18M€ soit en FEDER 4 374 000 € pour la e-administration, 4 092 000 € pour la e-inclusion, 688 000 € pour la e-santé, et 1 866 000 € pour la e-éducation.
Sont programmés avant la fin de l'année 2018 (18 projets) : 14 734 000 € de FEDER pour un coût total de projets de 25 959 000 €  soit  en FEDER 6 620 000 € pour la e-administration, 1 984 000 € pour la e-inclusion, 5 000 000 € pour la e-santé et 1 130 000 € pour la e-éducation.
```
...
(note dans la marge) * _source :  [http://www.europe-en-france.gouv.fr/Centre-de-ressources/Aides-d-Etat/Les-aides-de-minimis](http://www.europe-en-france.gouv.fr/Centre-de-ressources/Aides-d-Etat/Les-aides-de-minimis)_
...
(sous titre 2) 1.4- Les modèles de financement de la médiation numérique en question  
...
*   des effets d'aubaine <span style="text-decoration:underline;">(</span>dispositif Nouveaux Services-Emplois Jeunes,  les politiques publiques d'État tels que PAGSI et PAMSI, etc.) ;
*   la nécessité d'évolution des métiers (par exemple la transformation des médiathèques)*;

_(note dans la marge) * source : http://www.pratiquesculturelles.culture.gouv.fr/doc/08synthese.pdf)_



*   la réponse à l'évolution des attentes des publics (par exemple pour des centres sociaux et des régies de quartier);

_source : Enquête II. Les travailleurs sociaux, médiateurs numériques malgré eux._
...
_Insérer Cartographie Capgemini en pleine page (Antony > voir avec Alexandre pour cela)_


(encadré projet) Cas du développement de l'association ICI et du projet Net 94 
...
*   le consentement à payer est le plus souvent en réalité conditionné par le lieu qui propose le service : on envisage culturellement peu de payer un service d'immatriculation délivré dans une mairie. Le même service délivré chez un garagiste fera l'objet d'une facturation à l'usager.
    ...
    ```
(encadré projet) Cas de la dématérialisation de la demande de certificats d'immatriculation
...
(encadré projet) L'exemple de Simplon
...
(encadré projet) L'exemple WeTechCare 
